...
import com.example.githubprofiles.ui.profiledetails.viewmodel.ProfileDetailsViewModelFactory
...
interface ProfileDetailsDependenciesComponent {
    ...
    fun viewModel(): ProfileDetailsViewModel
    fun viewModelFactory(): ProfileDetailsViewModelFactory
}